...
public class PassengerMain extends AppCompatActivity implements View.OnClickListener {



    // 三个tab布局
    private RelativeLayout iWantKnowLayout, meLayout;

    // 底部标签切换的Fragment
    private Fragment iWantKnowFragment, meFragment,
            currentFragment;
    // 底部标签图片
    private ImageView  iWantKnowImg, meImg;
    // 底部标签的文本
    private TextView iWantKnowTv, meTv;
    ...
    private void initTab() {
        if (iWantKnowFragment == null) {
            iWantKnowFragment = new PassengerBrowse();
        }
        ...
        if (!iWantKnowFragment.isAdded()) {
            ...
            iWantKnowTv.setTextColor(getResources()
   ...
   /* private void clickTab1Layout() {
    ...
    private void clickTab3Layout() {
        if (meFragment == null) {
            meFragment = new PassengerImformation();
        }
